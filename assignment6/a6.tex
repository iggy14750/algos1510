...
Repeat until G is empty:
	...
	\begin{enumerate}[label=(\alph*)]
		...
		\begin{proof}
			Implementing this recursively means that (only needing to consider the last iteration of the sum) $T(n)$ is made of two recursive-call subtrees of 2 different sizes
		\end{proof}
